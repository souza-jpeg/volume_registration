...
generator = GeneratorRRDB(channels, num_res_blocks=residual_blocks).to(device)
...
train_set = TrainDatasetFromFolder(R'D:\volume_registration\ersgan_dataset\train_HR', crop_size=128, upscale_factor=8)
